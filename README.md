...
* Web page should be hosted using GitHub pages service
...
* Main Section
  ...
  * Three (3) additional content sections (for example)
    ...
    * Pricing information
  * HTML form (for example a Contact Form)
...
* If you are ill or any other issues arise that are beyond your control, please email [mispeln@algonquincollege.com](mailto:mispeln@algonquincollege.com) 24 hours before the specified due date to discuss alternate arrangements
* If you fail to inform me of any extenuating circumstances that cause a delay in your submission by the due date, you will receive a mark of **Zero (0)** for the assignment
